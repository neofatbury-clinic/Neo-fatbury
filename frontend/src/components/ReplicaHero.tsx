...
export default function ReplicaHero({
  ...
  return (
    <section className="replica-hero" style={{ 
      ...
      <div style={{ position: 'relative', zIndex: 10, display: 'grid', gridTemplateColumns: '1.5fr 500px', gap: '2rem', alignItems: 'center', width: '100%', paddingLeft: '0', paddingRight: '2rem' }}>
