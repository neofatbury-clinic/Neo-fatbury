    ...
    <section className="replica-hero">
      ...
      <div className="replica-primary-bg">
        <Image 
            ...
            priority 
            quality={95}
            style={{ objectFit: 'contain', objectPosition: 'left center', transform: 'scale(1.08)', transformOrigin: 'left center' }} 
          />
      ...
      <div className="replica-hero-container" style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div className="replica-primary-box">
          <div className="replica-primary-content">
            ...
            <div className="replica-zone-left desktop-only" style={{ minHeight: '680px' }}></div>
            ...
            <div className="replica-zone-middle">
              {titleTeal1 && (
                <h1 className="replica-title">
                  ...
                  {titleTeal2 && <span className="text-teal">{titleTeal2}</span>} 
                  {(titleTeal1 || titleTeal2) && (titleOrange1 || titleOrange2) && <br/>}
